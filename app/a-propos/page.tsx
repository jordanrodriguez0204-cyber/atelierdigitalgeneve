...
export default function AProposPage() {
  return (
    <div className="pt-16">
      {/* Hero */}
      <section className="bg-slate-900 py-20 px-4 overflow-hidden">
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="relative w-72 h-72">
                <svg viewBox="0 0 288 288" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full drop-shadow-2xl">
                  ...
                  {/* Cathedral (Saint-Pierre) - center left */}
                  ...
                  {/* Jet d'eau water spray particles */}
